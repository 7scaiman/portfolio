...
function Unit19(props) {
    return (
        <section className="unit-page">

            {/* LEFT ARROW */}
            <Link to="/Unit18" className="unit-arrow left-arrow">
                <IconButton>
                    <ArrowBackIosNewIcon />
                </IconButton>
            </Link>
            ...
            {/* RIGHT ARROW */}
            <Link to="/Unit22" className="unit-arrow right-arrow">
                <IconButton>
                    <ArrowForwardIosIcon />
                </IconButton>
            </Link>
            ...
            <div className="unit-container">
                ...
                <h1 className="unit-title">Unit 19</h1>

                <div className="unit-card">

                    <div className="unit-text">
                        <h2>Computing in the Workplace</h2>
